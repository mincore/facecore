...
class FaceAttr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fastore.FaceAttr) */ {
 public:
  FaceAttr();
  virtual ~FaceAttr();
 ...
 private:
  ...
  friend struct protobuf_fastore_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class TagAttr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fastore.TagAttr) */ {
 public:
  TagAttr();
  virtual ~TagAttr();
